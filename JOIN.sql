...
-- 오라클 전용 구문
-- FROM절에 ','로 구분하여 사용할 테이블을 다 기술하낟.
-- WHERE절에 합치기에 사용할 컬럼을 이용하영 조건을 기술한다.
